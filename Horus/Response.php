...
class Horus_Response
{
     ...
     * @return void
     */
    function header($string, $replace = false, $status = 200)
    {
    ...
    function send($output = '', $return = false)
    {
        ...
        // send the output
        // but if reqeust method is head, return null
     ...
     * @return mixed
     */
    protected function output($output = null, $replace = false)
    {
        if(is_null($output))
            return $this->output;
