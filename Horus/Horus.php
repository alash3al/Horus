...
class Horus
{
    ...
    public function __construct(array $configs = array())
    {
        ...
        // load some files
        require $this->coredir . 'Loader.php';
        ...
        // load some files
        require $this->coredir . 'Functions.php';
    ...
    {
        $tpl = '<!DOCTYPE HTML><html><head><meta charset="UTF-8" /><title> %s </title><style>*{virtecal-position: middle}body{margin:0; padding: 20px; font-family:Andalus}h1{color:#555}%s</style></head><body><h1> %s </h1>%s</body></html>';
