...
class Horus
{
    ...
    public function __construct(array $configs = array())
    {
        ...
        ini_set('session.hash_bits_per_character',  $this->configs('horus.session_hash_bits'));
        ...
        $this->http     =   new Horus_Http((bool) $this->config('horus.http_version'),(bool) $this->config('horus.enable_simulator'));
