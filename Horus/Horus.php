...
class Horus
{
    ...
    public function __construct(array $configs = array())
    {
        ...
        // load the classes loader
        require_once corepath . 'Loader.php';
        
        // start the classes loader
        // register Horus prefix/namespace
        $this->loader   =   new Horus_Loader(basepath); 
        $this->loader->register('Horus', corepath);
    ...
    protected function setup()
    {
        ...
        if($this->config('horus.use_router') == true) {
            if(!isset($this->router)) {
                $this->router = new Horus_Router($_SERVER['PATH_INFO']);
            }
        }
